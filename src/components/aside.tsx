...
export function Aside() {
  ...
  const handleMoreInfo = () => {
    ...
    window.open('https://www.ifcet.com.pe/seminarios-peritaje-contable', '_blank');
  };
  ...
  return (
    <aside className="h-screen py-8 hidden lg:block sticky top-20 z-10">
      <div className="px-4">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
          ...
          <div className="p-4">
            <div className="relative group">
              <video 
                src="https://www.ifcet.com.pe/wp-content/uploads/2025/07/seminarios-peritaje-contable-ifcet-peru.gif" 
                autoPlay 
                loop 
                muted 
              ...
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-all duration-300 rounded-lg flex items-center justify-center">
                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center">
                  <div className="bg-white/90 backdrop-blur-sm rounded-lg px-4 py-2 mx-4">
                    <p className="text-gray-800 font-semibold text-sm">Seminarios de Peritaje Contable</p>
            ...
            <div className="mt-4 text-center">
              <h4 className="font-bold text-gray-900 text-lg mb-2">Seminarios de Peritaje Contable</h4>
              <p className="text-gray-600 text-sm mb-3">
                Especialízate en peritaje contable con nuestros seminarios profesionales
              </p>
